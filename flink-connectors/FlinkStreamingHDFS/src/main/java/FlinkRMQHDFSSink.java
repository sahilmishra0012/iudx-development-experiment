...
public class FlinkRMQHDFSSink {
    public static void main(String[] args) throws Exception {
        ...
        final StreamingFileSink<GenericRecord> sink = StreamingFileSink
                .forBulkFormat(new Path("hdfs://localhost:9000/tmp/hdfsdata"), ParquetAvroWriters.forGenericRecord(schema)).withBucketAssigner(new EventTimeBucketAssigner()).withBucketCheckInterval(100000).withRollingPolicy(
